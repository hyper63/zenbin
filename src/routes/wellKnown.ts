...
- https://my-agent-site.zenbin.io/ (index page)
- https://my-agent-site.zenbin.io/about
...
|------|-------------|---------|
| Standalone page | /p/{id} | https://zenbin.io/p/my-report |
| Subdomain root | {subdomain}.zenbin.io/ | https://my-site.zenbin.io/ |
| Subdomain page | {subdomain}.zenbin.io/{path} | https://my-site.zenbin.io/about |
...
\`\`\`bash
# Claim subdomain
curl -X POST https://zenbin.io/v1/subdomains/agent-dashboard

# Create landing page
curl -X POST https://zenbin.io/v1/pages/index \\
...
# Add metrics page
curl -X POST https://zenbin.io/v1/pages/metrics \\
  -H "X-Subdomain: agent-dashboard" \\
  -H "Content-Type: application/json" \\
  -d '{
...
Live at: https://agent-dashboard.zenbin.io/
